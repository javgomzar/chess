...
class Castle:
    ...
    def execute(self, board: Board) -> None:
        ...
        self.piece = board.get_piece(king_position)
        self.rook = board.get_piece(Position(self.rook_col, self.color.king_row))

        board.set_position(self.piece, Position(self.final_king_col, self.color.king_row))
    ...
    def undo(self, board: Board) -> None:
        board.set_position(self.piece, Position(4, self.color.king_row))
